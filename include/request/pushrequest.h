...
class PushRequest : public Zway::Request
{
public:

    typedef std::shared_ptr<PushRequest> Pointer;
...
protected:
    ...
    PushRequest(uint32_t id, const Zway::UBJ::Object &request, Callback callback);
